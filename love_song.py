...
# TO DO:
# - (DONE BUT CHECK) beginning of mouse harmonies (before melody sounds odd)
# - first spoken (NEED TO SHOW THE BAR!)
# - tempos (100)
# - spacing of text at top
...
# - written by me! lyrics should be reflected in piano... (and "meek as well")
# - rit at end
# - (DONE BUT CHECK) beginning of mouse harmonies (before melody sounds odd)
# - harmony at "strive" is odd..
# - choose vocal entrance could be difficult
...
love_lines = [
           #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: 
           #0 ||-------|------||-------|------||-------|------||-------|------
        [      'r1\\fermata ^".........................." ^"But Tim," ^"I\'ve been so"  ^"mean to you!"',
               "",
        ...
        [      "R1",
               "",
               "\\times 2/3 {<e, g c>4\\f <d g b> <d g> ~}  <d g>  <g d'>4-> ~",
               "g->(    g,8    d'      a'->      g,8    d'      b'4->) ~",
        ],#13 ||-------|------||-------|------||-------|------||-------|------
        [      "R1",
               "",
...
mouse_lines = [
        ...
        [      "R1",
               "",
               "c'2\\p ~ c4.     f8( ", #"\\times 2/3 { d4(  <a' c>  e }  <g e'>4.)                c8(",
               "<a' e'>1",
        ], #1 ||-------|------||-------|------||-------|------||-------|------
        [      "R1",
               "",
        ...
        [      "R1",
               "",
               "f4(             e'               \\times 2/3 {f,4 <c' e>4 g ~ } ", #"f8[(   d']     e[      c])      f,4(             e",
               "d2                              a2 ~",
        ], #3 ||-------|------||-------|------||-------|------||-------|------
        [      "r2                              f4^\\p          e       ",
               "                                I               once    ",
        ...
        [      "r4              f^\\<           c               r8      c16  c",
               "                when            fate                    in-  ter- ",
               "<c, d f>2                       <c g'>4         c4",      #"c8.      e16    c8      c16  c",
               "g4              c,4             <a c g'>4              bf4",
        ], #7 ||-------|------||-------|------||-------|------||-------|------
...
me_lines = [
        ...
        [      'R1',
               "",
               copy.copy(swept_lines[6][2]), copy.copy(swept_lines[6][3]),
        ], #7 ||-------|------||-------|------||-------|------||-------|------
        [      "R1",
               "",
               copy.copy(swept_lines[7][2]), copy.copy(swept_lines[7][3]),
        ],
]
# ||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
...
choose_lines = [
           #::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: 
           #0 ||-------|------||-------|------||-------|------||-------|------
        [      'r1^"(spoken excitedly) And then the other" ^"Frog turned into a prince..." ^"and ever since, though I\'ve had hints..."',
               "",
               love_lines[7][2],
...
love_arrangement.extend_lines(swept_lines)
love_arrangement.extend_lines(end_lines)
